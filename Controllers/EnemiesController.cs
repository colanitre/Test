    ...
    private static EnemyDetailDto ToDto(Enemy enemy) =>
        new(
            ...
            enemy.EnemyClass != null ? new EnemyClassDto(
                ...
                enemy.EnemyClass.BaseLuck,
                enemy.EnemyClass.PhysicalResistance,
                enemy.EnemyClass.FireResistance,
                enemy.EnemyClass.IceResistance,
                enemy.EnemyClass.LightningResistance,
                enemy.EnemyClass.PoisonResistance,
                enemy.EnemyClass.HolyResistance,
                enemy.EnemyClass.ShadowResistance,
                enemy.EnemyClass.ArcaneResistance) : null,
            enemy.Level,
            enemy.Health,
            enemy.MaxHealth,
            enemy.Mana,
