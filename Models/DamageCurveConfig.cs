...
public class DamageCurveConfig
{
    ...
    public double EnemyDefenseWeight { get; set; } = 1.5;
    public double EnemyMagicDefenseWeight { get; set; } = 1.5;
    public double EnemyStaminaDefenseWeight { get; set; } = 1.5;
    ...
    public double CharacterDefenseWeight { get; set; } = 1.5;
    public double CharacterMagicDefenseWeight { get; set; } = 1.5;
    public double CharacterStaminaDefenseWeight { get; set; } = 1.5;
